...
extern int da_stem(struct SN_env * z);
...
extern struct SN_env * da_create_env(void);
extern void da_close_env(struct SN_env * z);
...
extern struct SN_env * da_create_env(void) { return SN_create_env(1, 1, 0); }

extern void da_close_env(struct SN_env * z) { SN_close_env(z); }
