...
extern int en_stem(struct SN_env * z);
...
extern struct SN_env * en_create_env(void);
extern void en_close_env(struct SN_env * z);
...
extern struct SN_env * en_create_env(void) { return SN_create_env(0, 2, 1); }

extern void en_close_env(struct SN_env * z) { SN_close_env(z); }
