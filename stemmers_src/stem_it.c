...
extern int it_stem(struct SN_env * z);
...
extern struct SN_env * it_create_env(void);
extern void it_close_env(struct SN_env * z);
...
extern struct SN_env * it_create_env(void) { return SN_create_env(0, 3, 0); }

extern void it_close_env(struct SN_env * z) { SN_close_env(z); }
