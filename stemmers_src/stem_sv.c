...
extern int sv_stem(struct SN_env * z);
static int r_other_suffix(struct SN_env * z);
static int r_consonant_pair(struct SN_env * z);
static int r_main_suffix(struct SN_env * z);
static int r_mark_regions(struct SN_env * z);

extern struct SN_env * sv_create_env(void);
extern void sv_close_env(struct SN_env * z);
...
extern struct SN_env * sv_create_env(void) { return SN_create_env(0, 1, 0); }

extern void sv_close_env(struct SN_env * z) { SN_close_env(z); }
