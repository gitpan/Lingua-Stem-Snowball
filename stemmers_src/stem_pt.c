...
extern int pt_stem(struct SN_env * z);
...
extern struct SN_env * pt_create_env(void);
extern void pt_close_env(struct SN_env * z);
...
extern struct SN_env * pt_create_env(void) { return SN_create_env(0, 3, 0); }

extern void pt_close_env(struct SN_env * z) { SN_close_env(z); }
