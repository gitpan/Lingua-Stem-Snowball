...
extern int es_stem(struct SN_env * z);
...
extern struct SN_env * es_create_env(void);
extern void es_close_env(struct SN_env * z);
...
extern struct SN_env * es_create_env(void) { return SN_create_env(0, 3, 0); }

extern void es_close_env(struct SN_env * z) { SN_close_env(z); }
