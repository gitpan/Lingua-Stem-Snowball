...
extern int ru_stem(struct SN_env * z);
...
extern struct SN_env * ru_create_env(void);
extern void ru_close_env(struct SN_env * z);
...
extern struct SN_env * ru_create_env(void) { return SN_create_env(0, 2, 0); }

extern void ru_close_env(struct SN_env * z) { SN_close_env(z); }
