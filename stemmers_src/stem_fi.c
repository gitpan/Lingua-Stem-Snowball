...
extern int fi_stem(struct SN_env * z);
...
extern struct SN_env * fi_create_env(void);
extern void fi_close_env(struct SN_env * z);
...
extern struct SN_env * fi_create_env(void) { return SN_create_env(1, 2, 1); }

extern void fi_close_env(struct SN_env * z) { SN_close_env(z); }
