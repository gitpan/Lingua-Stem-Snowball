...
extern int dk_stem(struct SN_env * z);
...
extern struct SN_env * dk_create_env(void);
extern void dk_close_env(struct SN_env * z);
...
extern struct SN_env * dk_create_env(void) { return SN_create_env(0, 2, 1); }

extern void dk_close_env(struct SN_env * z) { SN_close_env(z); }
