...
----------------------------------------------------------------------
    ...
    testfabien.h -- Perl/Pollution/Portability Version 3.06 
   
    Automatically created by Devel::PPPort running under
    perl 5.008004 on Mon Feb  7 10:33:04 2005.
    
    Do NOT edit this file directly! -- Edit PPPort_pm.PL and the
    includes in parts/inc/ instead.
 
    Use 'perldoc testfabien.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl testfabien.h [options] [files]
...
This version of F<testfabien.h> is designed to support operation with Perl
...
Tell F<testfabien.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<testfabien.h> if you intend to be backward compatible only
up to a certain Perl version.

=head2 --cplusplus

Usually, F<testfabien.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<testfabien.h> to leave C++
comments untouched.
...
F<testfabien.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<testfabien.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl testfabien.h --list-provided

to see which API elements are provided by testfabien.h.
...
also deprecated. You can safely use the supported API, as F<testfabien.h>
...
more C<#define>s in your source code before the inclusion of F<testfabien.h>.
...
Just C<#define> the macro before including C<testfabien.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "testfabien.h"
...
F<testfabien.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<testfabien.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<testfabien.h> can be run as a Perl script to check your
...
use something like this:
    ...
    perl testfabien.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl testfabien.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl testfabien.h --diff='diff -C 10'
...
use:
    ...
    perl testfabien.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl testfabien.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl testfabien.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<testfabien.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<testfabien.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error testfabien.h only works with Perl version 5
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, testfabien.h implements a version
